...
var flickr_menu = contextMenu.Menu({
  ...
  items: [
    contextMenu.Item({ label: 'Direct URL to clipboard',
                       data: 'direct' }),
    contextMenu.Item({ label: 'Download image',
                       data: 'save' }),
    contextMenu.Item({ label: 'Open image in a new tab',
                       data: 'tab' }),
    contextMenu.Item({ label: 'Shortened URL to clipboard',
                       data: 'shorten' }),
  ],
  label: "Flickr Saver: ",
...
var flickr_browse_menu = contextMenu.Menu({
  context: [
    contextMenu.SelectorContext('div.photo-list-photo-view'),
    contextMenu.URLContext('*.flickr.com'),
  ],
  contentScriptFile: require('sdk/self').data.url('flickr_browse_menu.js'),
  items: [
    contextMenu.Item({ label: 'Direct URL of full size image to clipboard',
                       data: 'direct' }),
    contextMenu.Item({ label: 'Download full size image',
                       data: 'save' }),
    contextMenu.Item({ label: 'Open full size image in a new tab',
                       data: 'tab' }),
    contextMenu.Item({ label: 'Shortened URL of full size image to clipboard',
                       data: 'tab' }),
  ],
  label: "Flickr Saver: ",
...
var flickr_feed_menu = contextMenu.Menu({
  context: [
    contextMenu.SelectorContext('div.session-image-wrapper'),
    contextMenu.URLContext('*.flickr.com'),
  ],
  contentScriptFile: require('sdk/self').data.url('flickr_feed_menu.js'),
  items: [
    contextMenu.Item({ label: 'Direct URL of full size image to clipboard',
                       data: 'direct' }),
    contextMenu.Item({ label: 'Download full size image',
